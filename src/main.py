...
if __name__ == '__main__':
    ...
    # Checkpoint folder that contains the generator.pth and discriminator.pth files for saving our models.
    ...
    # Define whether we use only the generator or the whole pipeline with the discriminator.
